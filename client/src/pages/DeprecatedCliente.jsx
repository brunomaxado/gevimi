    ...
    <div class="novoCliente">
      ...
      <div class="cliente">
        ...
        <p>
          ...
          <label className="asterisco">*</label>  Nome: <input
          type="text"
          placeholder="Nome"
          name="nome"
          ...
          required
        /></p>
        <p> <label className="asterisco">*</label> CPF:
        <input
          type="number"
          placeholder="CPF"
          name="cpf"
          ...
          required
        /></p>
        <p> <label className="asterisco">*</label> CELULAR: 
        <input
          type="number"
          placeholder="Celular"
          name="celular"
          ...
          required
        /></p>
        <p> <label className="asterisco-branco">*</label> CEP:
        <input
          type="number"
          placeholder="CEP"
          name="cep"
          ...
          onChange={handleChange}
        /></p>
        <p> <label className="asterisco">*</label> CIDADE:
        <input
          type="text"
          placeholder="Cidade"
          name="cidade"
          ...
          required
        /></p>
        <p> <label className="asterisco">*</label> BAIRRO:
        <input
          type="text"
          placeholder="Bairro"
          name="bairro"
          ...
          required
        /></p>
        <p>  <label className="asterisco">*</label> RUA:
        <input
          type="text"
          placeholder="Rua"
          name="rua"
          ...
          required
        /></p>
        <p> <label className="asterisco">*</label> NUMERO:
        <input
          type="text"
          placeholder="Número"
          name="numero"
