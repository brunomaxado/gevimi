...
const HelpEditarProduto = ({ isOpen, onRequestClose }) => {
    ...
    <div className="custom-modal-overlay">
      <div className="custom-modal">
        <div className="custom-modal-header">
          <h2>Ajuda na edição de dados do Produto</h2>
          <button className="custom-modal-close" onClick={onRequestClose}>
            &times;
          </button>
        </div>
        <div className="custom-modal-body">
          <h5><b>Editar dados de um Produto:</b></h5>
          <div className="modal-body-content">
            ...
            <dl>
              ...
              <dd>
                - Ao conferir e atestar que todos os dados estão de acordo e os campos 
                obrigatórios foram preenchidos, deve-se clicar no botão "Confirmar".
                 Se a alteração for bem-sucedida, um pop-up verde claro aparecerá na
                  parte superior da tela informando que foi bem-sucedido.
                   Caso contrário, o pop-up será vermelho, indicando que não foi possível.
                    Se bem-sucedido, você será redirecionado para a lista de todos os produtos cadastrados.
              </dd>
            </dl>
          </div>
        </div>
...
export default HelpEditarProduto;
